...
export class CncRouterService {
  ...
  relief = [
    ...
    { id: 108, title: "A 3D Relief Model of a Cougar and Elk in nature", price: "24$", pic: 'relief/animals/animal109.png', tPrice: 3600000, for: "router" },
    { id: 108, title: "A 3D Relief Model of a sitting Bunny Rabbit", price: "11$", pic: 'relief/animals/animal110.png', tPrice: 3600000, for: "router" },
    { id: 108, title: "A 3D Relief Model of a Raccoon emerging from a tree trunk.", price: "37$", pic: 'relief/animals/animal111.png', tPrice: 3600000, for: "router" },
  ...
  wallPanel = [
    { id: 101, title: "3DWP-2067 3D Wall Panel 3D Model 8x4 Size CNC Design Artcam File & STL 3D Model Download", price: "27$", pic: 'wallPanel/wall101.png', tPrice: 3600000, for: "router" },
    { id: 102, title: "3DWP-2043 3D Wall Panel 3D Model 8x4 Size CNC Design Artcam File & STL 3D Model Download", price: "17$", pic: 'wallPanel/wall102.png', tPrice: 3600000, for: "router" },
    { id: 103, title: "3DWP-2001 3D Wall Panel 8x4 CNC Design 3D Model Relief And STL Download", price: "25$", pic: 'wallPanel/wall103.png', tPrice: 3600000, for: "router" },
    { id: 104, title: " 3D Wall Panel 3D Model 8x4 Size CNC Design Artcam File & STL 3D Model ", price: "32$", pic: 'wallPanel/wall104.png', tPrice: 3600000, for: "router" },
    { id: 105, title: "decor set wall panel wall relief mural CNC 34 3D model", price: "20$", pic: 'wallPanel/wall105.png', tPrice: 3600000, for: "router" },
    { id: 106, title: "3D Wall Paneling, MDF Wall Decorative Panels, CNC MDF Cutting, Thickness", price: "20$", pic: 'wallPanel/wall106.png', tPrice: 3600000, for: "router" },
    { id: 107, title: "decor set wall panel wall relief mural CNC 64 3D model", price: "18$", pic: 'wallPanel/wall107.png', tPrice: 3600000, for: "router" },
    { id: 108, title: "Wall panel PAN 002 | CNC Woodworking and Panels", price: "20$", pic: 'wallPanel/wall108.png', tPrice: 3600000, for: "router" },
    { id: 109, title: "3D Wall Paneling, MDF Wall Decorative Panels, CNC MDF Cutting, Thickness: 12mm To 25mm", price: "25$", pic: 'wallPanel/wall109.png', tPrice: 3600000, for: "router" },
    { id: 110, title: "    3D Wall panel Model for CNC and STL 3D printers 40", price: "30$", pic: 'wallPanel/wall110.png', tPrice: 3600000, for: "router" },
